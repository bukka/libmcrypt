...
*  on a curve, add and double points for optimal normal bases.          *
*                                                                       *
...
*  15 multiplies for projective math.  Using the opt_inv of Dave Dahm,      *
*  a multiply takes as long as an invert.                                   *
****************************************************************************/
